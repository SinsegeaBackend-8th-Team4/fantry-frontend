<template>
  <div class="header">
    <div>
      <h1 class="h3 mb-2 text-gray-800">구제 신청 목록 조회</h1>
      <p class="mb-4">구제 신청이 접수된 회원 신고 내역을 확인하고 처리하는 페이지입니다.</p>
    </div>
    <button class="bottom btn btn-primary" @click="registReport">신고 등록</button>
  </div>
  ...
  <div>
    ...
    <ServerDataTable
      ...
      :columns="columns"
      :fetcher="fetchReceivedReports"
      :page-size="10"
    >
      <!-- 데이터가 없을 때 -->
      <template #empty>접수된 구제 신청 내역이 없습니다.</template>
    </ServerDataTable>
  </div>
</template>
